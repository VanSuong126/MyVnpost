...
import { View, Text, StyleSheet, Image, SafeAreaView, TextInput, Pressable, ScrollView } from "react-native";
// import image
...
import RadioButton from "../Plugins/Radiobutton";
...
const SenderInformation = () => {
    ...
    const [SenderAddress, setSenderAddress] = useState('125 Hai Bà Trưng, phường Bến Nghé, Quận 1')
    const SetValue = () => {
        setSenderPhone();
        setSenderAddress();
    }
        ...
        <View style={styles.warp_info}>
            <View style={[styles.wrap_sender_info, styles.boxShadow]}>
                <View style={styles.wrap_title}>
                    ...
                    <Pressable style={styles.img_arrow} onPress={() => SenderCollapse(isVisibleSender)}>
                        {isVisibleSender && isVisibleSender == true ? <Image source={ArrowDown} /> : <Image source={ArrowUp} />}
                    </Pressable>
                </View>
                {isVisibleSender && isVisibleSender == true ?
                    <View style={styles.wrap_info_up}>
                        <Text style={styles.txt_info}> {SenderName} - {SenderPhone}</Text>
                        <Text style={styles.txt_info}>{SenderAddress}</Text>
                    </View> :
                    <View style={styles.wrap_info_up}>
                        <TextInput style={styles.txp_search} placeholder="Tìm kiếm bằng họ tên, số điện thoại..." />
                        <View style={styles.wrap_input}>
                            <View style={styles.wrap_icon}>
                                <Text style={styles.star}>*</Text>
                                <Image style={styles.icon_txp} source={Bell} />
                            </View>
                            <TextInput style={styles.txp_info_enter} placeholder='Nhập tên người gửi' />
                        </View>
                        <View style={styles.wrap_input}>
                            <View style={styles.wrap_icon}>
                                <Text style={styles.star}>*</Text>
                            ...
                            <TextInput style={styles.txp_info_enter} placeholder='Nhập số điện thoại người gửi' />
                        </View>
                        <View style={styles.wrap_input}>
                            <View style={styles.wrap_icon}>
                                <Text style={styles.star}>*</Text>
                            ...
                            <TextInput style={styles.txp_info_enter} placeholder='Nhập địa chỉ người gửi' />
                        </View>
                    </View>}
            </View>
        </View>
...
const ReceiverInformation = () => {
    ...
    const [ReveiverAddress, setReveiverAddress] = useState('293 Tôn Đản, P.15, Quận 4')
    const SetValue = () => {
        setReveiverPhone();
        setReveiverAddress();
    }
        ...
        <View style={styles.warp_info}>
            <View style={[styles.wrap_Reveiver_info, styles.boxShadow]}>
                <View style={styles.wrap_title}>
                    ...
                    <Pressable style={styles.img_arrow} onPress={() => ReveiverCollapse(isVisibleReveiver)}>
                        {isVisibleReveiver && isVisibleReveiver == true ? <Image source={ArrowDown} /> : <Image source={ArrowUp} />}
                    </Pressable>
                </View>
                {isVisibleReveiver && isVisibleReveiver == true ?
                    <View style={styles.wrap_info_up}>
                        <Text style={styles.txt_info}> {ReveiverName} - {ReveiverPhone}</Text>
                    ...
                    <View style={styles.wrap_info_up}>
                        ...
                        <View style={styles.wrap_input}>
                            ...
                            <TextInput style={styles.txp_info_enter} placeholder='Nhập tên người nhận' />
                        </View>
                        <View style={styles.wrap_input}>
                            <View style={styles.wrap_icon}>
                                <Text style={styles.star}>*</Text>
                            ...
                            <TextInput style={styles.txp_info_enter} placeholder='Nhập số điện thoại người nhận' />
                        </View>
                        <View style={styles.wrap_input}>
                            <View style={styles.wrap_icon}>
                                <Text style={styles.star}>*</Text>
                            ...
                            <TextInput style={styles.txp_info_enter} placeholder='Nhập địa chỉ người nhận' />
                        </View>
                    </View>
                }
            ...
            <View style={[styles.wrap_Reveiver_info, styles.boxShadow]}>
                ...
                <View style={styles.wrap_info_up}>
                    <View style={styles.wrap_input}>
                        ...
                        <TextInput style={styles.txp_info_enter} placeholder='Nội dung hàng hóa' />
                    </View>
                    <View style={styles.wrap_ordercode_weight}>
                        <View style={styles.wrap_input_ordercode}>
                            ...
                            <TextInput style={styles.txp_info_enter} placeholder='Mã đơn hàng' />
                        </View>
                        <View style={styles.wrap_input_weight}>
                            ...
                            <TextInput keyboardType={'numeric'} style={styles.txp_info_enter} placeholder='Trọng lượng' />
                    ...
                    {isVisibleSize && isVisibleSize == true ?
                        <View style={styles.wrap_input_size}>
                            <View style={styles.wrap_input_length}>
                                <TextInput keyboardType={'numeric'} style={styles.txp_info_enter} placeholder='Dài' />
                                <Text style={styles.txt_unit}>cm</Text>
                            </View>
                            <View style={styles.wrap_input_width}>
                                <TextInput keyboardType={'numeric'} style={styles.txp_info_enter} placeholder='Rộng' />
                                <Text style={styles.txt_unit}>cm</Text>
                            </View>
                            <View style={styles.wrap_input_height}>
                                <TextInput keyboardType={'numeric'} style={styles.txp_info_enter} placeholder='Cao' />
                                <Text style={styles.txt_unit}>cm</Text>
                            </View>
                        </View> : null
                    }
        ...
        <View style={styles.warp_info}>
            <View style={[styles.wrap_sender_info, styles.boxShadow]}>
                ...
                <View style={styles.wrap_list_extra_service}>
                    <View style={styles.wrap_group_checkbox}>
                        <View style={styles.wrap_checkbox}>
                            <View style={styles.wrap_check_extra}>
                                <CheckBox title={'Giao hàng thu tiền (COD)'} onSelect={(value) => setCheckBoxCOD(value)} />
                                {valueCheckCOD && valueCheckCOD == 1 ?
                                    <View style={styles.wrap_input_extra}>
                                        <TextInput keyboardType={'numeric'} style={styles.txp_info_enter} placeholder='Nhập số tiền' />
                        ...
                        <View style={styles.wrap_checkbox}>
                            <View style={styles.wrap_check_extra}>
                                <CheckBox title={'Khai giá'} onSelect={(value) => setCheckBoxInsurance(value)} />
                                {valueCheckInsurance && valueCheckInsurance == 1 ?
                                    <View style={styles.wrap_input_extra}>
                                        <TextInput keyboardType={'numeric'} style={styles.txp_info_enter} placeholder='Nhập giá trị' />
                                        <Text style={styles.txt_unit}>đ</Text>
                                    </View> : null}
                            </View>
                        </View>
                    ...
                    <View style={styles.wrap_group_checkbox}>
                        <View style={styles.wrap_checkbox}>
                            <CheckBox title={'Báo phát (AR)'} onSelect={(value) => setCheckBoxReport(value)} />
                        </View>
                        <View style={styles.wrap_checkbox}>
                            <CheckBox title={'Dịch vụ hóa đơn'} onSelect={(value) => setCheckBoxBill(value)} />
                        </View>
                    </View>
                </View>
            </View>
        ...
        <View style={styles.warp_info}>
            <View style={[styles.wrap_sender_info, styles.boxShadow]}>
                ...
                <View style={styles.wrap_list_extra_service}>
                    <View style={styles.wrap_group_checkbox}>
                        <View style={styles.wrap_checkbox}>
                            <CheckBox title={'EMS cây cảnh'} onSelect={(value) => setvalueEMSTree(value)} />
                        </View>
                    </View>
                </View>
            </View>
